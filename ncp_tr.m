function [FF, PP] = ncp_tr(candidates)
...
verticalOffset = 0;
text(best_param, minValue + verticalOffset, label, 'VerticalAlignment', 'bottom', 'HorizontalAlignment', 'left', 'FontSize', 32, 'Color', 'red');
hold off;
